...
{
    internal static class AMarkupExtensionHelper
    {
        /// <summary>
        ...
        public static Assembly RetrieveLocalAssembly([NotNull] IServiceProvider serviceProvider)
        {
            ...
            var rootProvider = (Avalonia.Markup.Xaml.IRootObjectProvider)serviceProvider.GetService(typeof(Avalonia.Markup.Xaml.IRootObjectProvider));
            if (assembly == null)
            {
                try
                {
