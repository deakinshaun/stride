...
namespace Stride.Core.Translation.Presentation.MarkupExtensions
{
    ...
    public class ALocalizeExtension : MarkupExtension
    {
        /// <summary>
        /// Creates a new instance of the <see cref="LocalizeExtension"/> class.
        /// </summary>
        public ALocalizeExtension()
        {
        ...
        public ALocalizeExtension(object text)
        {
            Text = text?.ToString();
        }
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            var assembly = AMarkupExtensionHelper.RetrieveLocalAssembly(serviceProvider);
            if (Count != null && !string.IsNullOrEmpty(Plural))
            {
                Count.Converter = new APluralConverter(Text, Plural, Context, assembly, IsStringFormat);
        ...
        private class APluralConverter : IValueConverter
        {
            ...
            public APluralConverter([NotNull] string text, [NotNull] string plural, string context, Assembly assembly, bool isStringFormat)
            {
