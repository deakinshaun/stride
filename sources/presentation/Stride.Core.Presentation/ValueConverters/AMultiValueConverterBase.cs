...
namespace Stride.Core.Presentation.ValueConverters
{
    ...
    public abstract class AMultiValueConverterBase<T> : MarkupExtension, IMultiValueConverter where T : class, IMultiValueConverter, new()
    {
        ...
        protected AMultiValueConverterBase()
        {
