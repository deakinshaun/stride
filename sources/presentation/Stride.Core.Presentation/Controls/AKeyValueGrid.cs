...
namespace Stride.Core.Presentation.Controls
{
    ...
    public class AKeyValueGrid : Grid
    {
        private bool gridParametersInvalidated;

        public static readonly StyledProperty<bool> UseFullRowProperty = StyledProperty<bool>.Register<AKeyValueGrid, bool>("UseFullRow");

        /// <summary>
        /// Initializes a new instance of the <see cref="KeyValueGrid"/> class.
        /// </summary>
        public AKeyValueGrid()
        {
        ...
        /// <inheritdoc/>
        private void OnVisualChildrenChanged(object? sender, NotifyCollectionChangedEventArgs e)
        {
