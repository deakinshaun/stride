...
{
    public class AVector3Editor : AVectorEditor<Vector3?>
    {
        /// <summary>
        /// Identifies the <see cref="X"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float?> XProperty = StyledProperty<float?>.Register<AVector3Editor, float?>("X", null, defaultBindingMode: BindingMode.TwoWay);

        /// <summary>
        /// Identifies the <see cref="Y"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float?> YProperty = StyledProperty<float?>.Register<AVector3Editor, float?>("Y", null, defaultBindingMode: BindingMode.TwoWay);

        /// <summary>
        /// Identifies the <see cref="Z"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float?> ZProperty = StyledProperty<float?>.Register<AVector3Editor, float?>("Z", null, defaultBindingMode: BindingMode.TwoWay);

        /// <summary>
        /// Identifies the <see cref="Length"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float?> LengthProperty = StyledProperty<float?>.Register<AVector3Editor, float?>("Length", null, defaultBindingMode: BindingMode.TwoWay);

        static AVector3Editor()
        {
            //            DefaultStyleKeyProperty.OverrideMetadata(typeof(Vector3Editor), new FrameworkPropertyMetadata(typeof(Vector3Editor)));
            XProperty.Changed.AddClassHandler<AVector3Editor>(OnComponentPropertyChanged);
            YProperty.Changed.AddClassHandler<AVector3Editor>(OnComponentPropertyChanged);
            ZProperty.Changed.AddClassHandler<AVector3Editor>(OnComponentPropertyChanged);
            LengthProperty.Changed.AddClassHandler<AVector3Editor>(OnComponentPropertyChanged);
        }
