...
namespace Stride.Core.Presentation.View
{
    ...
    /// </summary>
    public class ADispatcherService : IDispatcherService
    {
        ...
        /// <returns></returns>
        [NotNull]
        public static ADispatcherService Create()
        {
            return new ADispatcherService(Dispatcher.UIThread);
        }
        ...
        public ADispatcherService([NotNull] Dispatcher dispatcher)
        {
