...
namespace Stride.Core.Presentation.Behaviors
{
    ...
    /// </summary>
    public static class ABindableSelectedItemsControl
    {
    ...
    public abstract class ABindableSelectedItemsBehavior<T> : ADeferredBehaviorBase<T> where T : Control
    {
        ...
        /// </summary>
        public static readonly StyledProperty<IObservableList<object>> SelectedItemsProperty = StyledProperty<IObservableList<object>>.Register<ABindableSelectedItemsBehavior<T>, IObservableList<object>>(nameof(SelectedItems), null);

        /// <summary>
        /// Identifies the <see cref="GiveFocusOnSelectionChange"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<bool> GiveFocusOnSelectionChangeProperty = StyledProperty<bool>.Register<ABindableSelectedItemsBehavior<T>, bool>(nameof(GiveFocusOnSelectionChange), true);
        ...
        static ABindableSelectedItemsBehavior ()
        {
            SelectedItemsProperty.Changed.AddClassHandler< ABindableSelectedItemsBehavior < T >> (SelectedItemsChanged);
        }
        ...
        {
            var behavior = (ABindableSelectedItemsBehavior<T>)d;
