...
namespace Stride.Core.Presentation.Behaviors
{
    ...
    public abstract class ADeferredBehaviorBase<T> : Behavior<T> where T : AvaloniaObject
    {
        /// <summary>
        /// Represents the <see cref="AttachOnEveryLoadedEvent"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> AttachOnEveryLoadedEventProperty =
            StyledProperty<bool>.Register< ADeferredBehaviorBase < T > , bool >(nameof(AttachOnEveryLoadedEvent), false);
