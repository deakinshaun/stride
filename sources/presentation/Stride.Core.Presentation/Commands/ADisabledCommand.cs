...
namespace Stride.Core.Presentation.Commands
{
    ...
    public sealed class ADisabledCommand : AICommandBase
    {
        static ADisabledCommand()
        {
            Instance = new ADisabledCommand();
        }

        /// <summary>
        /// Gets a singleton instance of the <see cref="DisabledCommand"/>
        /// </summary>
        public static ADisabledCommand Instance { get; private set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="DisabledCommand"/> class.
        /// </summary>
        private ADisabledCommand()
        {
        }
