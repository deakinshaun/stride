...
namespace Stride.Core.Presentation.Themes
{
    ...
    public static class AImageThemingUtilities
    {
        /// <summary>
        ...
        public static Avalonia.Media.Drawing TransformDrawing(Avalonia.Media.Drawing drawing, IconTheme theme, bool checkLuminosity = true)
        {
 ...
 /*           if (drawing is GeometryDrawing gd && gd.Brush is SolidColorBrush s)
        ...
        /// <returns></returns>
        private static double TransformLuminosity(Drawing.HslColor hsl, double backgroundLuminosity)
        {
            var hue = hsl.Hue;
