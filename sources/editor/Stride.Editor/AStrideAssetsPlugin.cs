...
namespace Stride.Editor
{
    ...
    public abstract class AStrideAssetsPlugin : AssetsPlugin
    {
        ...
        public override void RegisterAssetEditorViewModelTypes([NotNull] IDictionary<Type, Type> assetEditorViewModelTypes)
        {
            ...
            foreach (var type in pluginAssembly.GetTypes())
            {
                ...
                {
                    var attribute = type.GetCustomAttribute<AAssetEditorViewModelAttribute>();
                    if (attribute != null)
                    {
