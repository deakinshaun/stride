...
{ 
    public class AGameStudioThumbnailService : IThumbnailService
    {
        ...
        public ListBuildStep Compile(AssetItem asset, Asset gameSettings)
        {
            ...
            return thumbnailCompiler.Compile(asset, (GameSettingsAsset) gameSettings, HasStaticThumbnail(asset.Asset.GetType()));
        }
