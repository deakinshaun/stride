...
namespace Stride.Core.Assets.Editor.Components.DebugTools.UndoRedo.Views
{
    ...
    /// </summary>
    public partial class ADebugUndoRedoUserControl : UserControl, IDebugPage, IDestroyable
    {        
        public ADebugUndoRedoUserControl(IViewModelServiceProvider serviceProvider, IUndoRedoService undoRedo)
        {
            InitializeComponent();
