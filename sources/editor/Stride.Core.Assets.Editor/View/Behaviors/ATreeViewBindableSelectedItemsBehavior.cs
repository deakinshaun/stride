...
using ATreeView = Stride.Core.Presentation.Controls.ATreeView;

namespace Stride.Core.Assets.Editor.View.Behaviors
{
    public class ATreeViewBindableSelectedItemsBehavior : ABindableSelectedItemsBehavior<ATreeView>
    {
