...
namespace Stride.Core.Assets.Editor.View.Behaviors
{
    ...
    public abstract class AActivateOnLogBehavior<T> : AActivateOnCollectionChangedBehavior<T> where T : AvaloniaObject
    {
        ...
        /// </summary>
        public static StyledProperty<LogMessageType> MinimumLevelProperty = StyledProperty < LogMessageType >.Register<AActivateOnLogBehavior<T>, LogMessageType>("MinimumLevel", LogMessageType.Debug);
    ...
    /// </summary>
    public class ATabItemActivateOnLogBehavior : AActivateOnLogBehavior<TabItem>
    {
