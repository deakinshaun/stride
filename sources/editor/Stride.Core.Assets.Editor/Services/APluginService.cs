...
{
    public class APluginService : IAssetsPluginService
    {
        ...
        protected readonly Dictionary<Type, Type> assetEditorViewModelTypes = new Dictionary<Type, Type>();
...
//                var dialogService = session.ServiceProvider.Get<IEditorDialogService>();
                var dialogService = session.ServiceProvider.Get<IEditorDialogService>();  //FIXME
        ...
        public virtual IEditorView ConstructEditionView(AssetViewModel asset)
        {
