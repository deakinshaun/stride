...
namespace Stride.Core.Assets.Editor.Services
{
    ...
    /// </summary>
    public interface AIEditorDialogService : IDialogService
    {
        /// <summary>
        ...
        void RegisterDefaultTemplateProvider(AITemplateProvider provider);

        void RegisterAdditionalTemplateProvider(AITemplateProvider provider);
