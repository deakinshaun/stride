...
namespace Stride.GameStudio.Layout
{
    ...
    /// </summary>
    internal class ADockingLayoutManager
    {
        ...
        private struct BindingInfo
        {
            ...
            private BindingInfo(Binding binding, AvaloniaProperty property)
            {
                Binding = binding;
                Property = property;
            }
...
/*            public static BindingInfo FromBindingExpression(BindingExpression bindingExpression)
        ...
        public ADockingLayoutManager(AGameStudioWindow gameStudioWindow, SessionViewModel session)
        {
